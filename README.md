...
<details>
<summary> 
Project60 - Препроцессор что это. Директива #define. Макросы. Директивы препроцессора что это. C ++ Урок #66-67 - Видео №66-67.
</summary>
...
<details>
<summary> 
Project62 - Условный тернарный оператор что это. Как работает. Как использовать. C ++ Для начинающих. Урок #69 - Видео 69.
</summary>
