...
2. int = 4
3. double = 8
* Чтобы это всё определить, не обезательно запоминать, а достаточно применить sizeof, наглядный показанный в данном уроке.
...
<details>
<summary> 
Что такое динамическая память. Утечка памяти. Стек и куча. Статическая память. Обзорный урок #45. - Видео 55.
</summary>

* [Ссылка на видео - 42](https://www.youtube.com/watch?v=l75xG4930bc&list=PLQOaTSbfxUtCrKs0nicOg2npJQYSPGO9r&index=55)
...
<details>
<summary> 
Project39 - Рекурсия что это. Рекурсия программирование. Рекурсия и цикл. Рекурсия с++. Для начинающих. Урок #43 - Видео №53.
</summary>

###
* Рекурсия. Если на неё посмотреть, она работает в виде счётчика for но в обратном порядке.
Зададим 5ть итераций (операций).
...
###
![Картика ПРимера Рекурсии под урок](dop_materialu/rekursia.jpg)
